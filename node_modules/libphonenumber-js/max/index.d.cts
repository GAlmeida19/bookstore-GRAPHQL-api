...
export {
    ...
    CountryCode, E164Number, Examples, Extension, MetadataJson, NationalNumber, NumberFormat, NumberFound, NumberFoundLegacy, NumberType, NumberingPlan, ParseError, PhoneNumber, ValidatePhoneNumberLengthResult
};
